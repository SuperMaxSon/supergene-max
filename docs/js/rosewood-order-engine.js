...
/* 아이템 아트 — 파일명이 곧 item_code (docs/img/items/<code>.png). 문서 기준 상대경로라
   ...
   236종 중 158장만 왔다 — 공구·차·찻잔·빵·꽃·수건·꿀 일곱 체인이 통째로 없다.
   없는 코드는 지금까지처럼 이름 글자로 그린다.
   ⚠ 아트와 이름이 어긋나는 코드가 있다(104 는 이름이 「공구함」인데 그림은 커피머신).
      아트는 item_spec 신판, 이름은 로컬 구판 xlsx(2026-09-08) 기준이라 그런 것으로 보인다 — 확인 필요. */
const SPRITE_CODES = new Set([101,102,103,104,105,106,107,108,109,110,111,301,302,303,304,305,306,307,401,402,403,404,405,406,407,408,409,410,411,701,702,703,704,705,706,707,708,709,710,711,901,902,903,904,905,906,907,1001,1002,1003,1004,1005,1006,1007,1008,1009,1010,1201,1202,1203,1204,1205,1206,1207,1208,1209,1210,1211,1501,1502,1503,1504,1505,1506,1507,1508,1509,1510,1511,1701,1702,1703,1704,1705,1706,1707,1801,1802,1803,1804,1805,1806,1807,1901,1902,1903,1904,1905,1906,1907,1908,1909,1910,2001,2002,2003,2004,2005,2006,2101,2102,2103,2104,2105,2106,2107,2108,2109,2110,2201,2301,2302,2303,2304,2305,2306,2307,2308,2309,2310,2401,2402,2403,2404,2405,2406,2501,2502,2601,2602,2701,2702,2703,2704,2705,2801,2802,2803,2804,2901,2902,2903,2904,2905,3001,3101,3102,3103]);
