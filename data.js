...
const SECTIONS = [
  {
    ...
    cards: [
      ...
      {
        title: "로딩 타임라인",
        desc: "NRU·RU 가 실행해서 첫 입력까지, 그리고 인게임↔아웃게임 전환마다 무엇을 얼마나 몇 초 받는지 간트로 그렸습니다. 회선(WiFi·4G·3G) 토글.",
  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        desc: "두 축의 구조를 도식 5장으로 세운 문서입니다. 직전 판본(v1.4 · 09-18)의 «아웃게임 5층이 통째로 비었다»는 전제가 깨졌습니다 — 그 축이 4,122줄로 서서(마을 · 채팅 러너 · 꾸미기 · 심부름) 이제 인게임과 대등한 두 축입니다. 그래서 이 판본은 «어디가 비었나»가 아니라 «무엇이 무엇을 부르고, 어디서 주입하고, 어디에 남기나»를 그립니다 — 박스보다 화살표가 본문입니다. 다섯 장은 전체(진입 분기 + 공유층) · 인게임(통지와 명령이 한 쌍) · 아웃게임(한 구간이 흐르는 길) · 주입과 저장(setClock → init → bootstrap → refillRail 의 순서 계약과 저장 키 5개) · 전환(커튼이 로드를 가리는 순서, 그리고 왕복이 onHideStart 를 안 타서 생기는 재진입 함정)입니다.",
  ...
  },
  {
    ...
    cards: [
      ...
      {
        title: "로즈우드 자동 플레이",
        desc: "초기 보드 63칸에서 자동 플레이어가 심부름 → 오더 → 머지·생산 순으로 스스로 게임을 합니다. 심부름은 main_task 비용·보상 그대로, 보상 아이템은 보관함에 쌓였다가 빈 칸이 생기면 내려오고, 레벨·경험치·코인·오더 레일 6칸과 병합·에너지 소모·클리어 횟수를 실시간으로 봅니다.",
