...
const SECTIONS = [
  ...
  },
  {
    ...
    cards: [
      {
        title: "QA 이슈 트래커",
        desc: "솔리테어 QA 채널의 이슈와 그 대응을 한눈에 보는 상시 목록. 남은 것 3건이 맨 위에 있고, 끝난 20건은 히스토리로 쌓인다. 각 행에 무엇을 했는지 한 줄과 근거(파일:라인)가 있고, 커밋을 누르면 커밋 히스토리의 해당 항목으로 넘어간다.",
