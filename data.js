...
const SECTIONS = [
  {
    ...
    cards: [
      ...
      },
      {
        ...
        desc: "2머지 한 벌을 인게임 8·아웃게임 11 묶음으로 갈라 있음 21 / 개선 24 / 없음 99 로 표시한 TODO 매트릭스. 아이템 타입 10·상태 6·재화 6·뺀 기믹 4를 타입별 아이콘 도감으로 그려, 22칸 중 코드가 있는 3칸을 색으로 셉니다.",
        url: "docs/story-merge-kickoff.html",
        project: "smg",
        status: "초안",
        version: "v2.2",
        updated: "2026-08-27 21:40",
        pinned: false,
        tags: ["착수 점검", "역기획", "스토리머지", "시스템 언팩", "인게임·아웃게임", "아이템 도감"],
      },
      {
