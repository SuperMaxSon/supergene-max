    ...
    cards: [
      {
        ...
        desc: "3374 ↔ 3375. 두 빌드는 이 처치 말고 코드가 같습니다. 생성 시도는 −38%인데 실제 생성 성공은 +5.8%로 늘었고 다른 지면 이탈도 없습니다. 잔존은 D+1~D+11 전체를 뽑아도 처치 층 11일 중 9일 B 우세(부호검정 p≈0.065)로 유의수준 직전입니다.",
        url: "docs/coin-match-tournament-reject-ab.html",
        project: "cmt",
        status: "진행중",
        version: "v1.5",
        updated: "2026-09-07 10:48",
        pinned: false,
