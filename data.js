...
const SECTIONS = [
  {
    ...
    cards: [
      ...
      {
        title: "솔 토너 생성률이 낮은 이유",
        desc: "낮은 게 아니라 모바일에서 작동하지 않는다. 1주일(8/10~16, US) 기준 생성률 Android 0.26% · iOS 273시도 0건 · Windows 6.69%인데, 마종은 반대로 모바일이 데스크톱의 2배(33.67% vs 15.82%). 같은 화면에서 공유는 10.05%로 살아 있어 유저 태도·피로·노출량으로 설명 불가 — 실패의 73%가 USER_INPUT이라 창은 열리고 전부 닫힌다. 사내 7개 중 우리만 가로(1280×720)이고 모바일 가로는 세로 공간 ~360px. 원인 후보 11개 배제, 남은 1순위는 가로. 확인은 실기 녹화 30분.",
        url: "docs/viral-orientation-gap.html",
        status: "진행중",
        version: "v3.0",
        updated: "2026-08-18 15:21",
        pinned: false,
