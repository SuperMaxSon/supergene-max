...
const SECTIONS = [
  ...
  },
  {
    ...
    cards: [
      ...
      {
        title: "심부름 보상 시트",
        desc: "런칭분 188건이 무엇을 받고 무엇을 무는지를 그림째 폈습니다. 코인·경험치·추가 아이템을 전부 실제 게임 아트로 세워, 코드(2501)만 보고는 알 수 없던 「무엇이 나오는가」가 바로 보입니다. 행을 누르면 그 심부름을 끝냈을 때 재생되는 대화가 채팅 화면으로 펼쳐집니다. 시트 신판(story 226행 · story_dialog 2,214행)으로 scene을 심부름마다 연결해 188건 전부에 대화가 붙습니다. 재생 시점이 착수·완료·구역 완료로 갈리고, 한글 대사 2,164줄을 그대로 실었습니다 — 대사가 비어 있는 심부름은 없습니다. 구역 6개는 색으로 갈랐습니다. NPC 아바타는 아트 반입 전이라 자리만 잡아 뒀습니다. 다만 그건 전부 시트와 기획서 이야기입니다 — 「데코 반영 현황」 섹션이 같은 188건을 「그래서 게임에 들어와 있나」로 다시 셉니다. 꾸미기 자리 130개 중 클라에 들어온 건 day 1 의 5개뿐이고, 데코 아트는 0장, 택1 키가 담긴 skin_deco 탭은 export 에 아예 없습니다.",
        url: "docs/chore-reward-sheet.html?v=20260921e",
        project: "smg",
        status: "완료",
