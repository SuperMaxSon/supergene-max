...
const SECTIONS = [
  {
    ...
    cards: [
      {
        title: "바이럴 지면 로직 — 벤치 4종 대조",
        desc: "솔리테어의 공유·초대·메시지·컨텍스트 전환 지면을 코지·퍼블마·마종·코인매치 코드와 대조. 차이 11건 중 벤치 전원이 같은데 우리만 다른 것은 4건 — 피드 공유 shareAsync 호출 방식, 지면마다 다른 공유 페이로드, 숫자로 나가는 3500 position, 결과창 공유의 3600+3500 이중 기록. 표 하나로 무엇이·어떻게·왜 문제인지만 남겼고 할 일은 확정력 순서로 4줄.",
        url: "docs/viral-surface-cross-project.html",
        status: "완료",
        version: "v2.0",
        updated: "2026-08-18 16:59",
        pinned: false,
        tags: ["바이럴", "공유", "초대", "4프로젝트", "코드실측", "로그정의"],
      },
      {
