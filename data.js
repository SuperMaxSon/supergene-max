...
const SECTIONS = [
  {
    ...
    cards: [
      ...
      },
      {
        ...
        desc: "카드 17장 + 칩 32개 오픈맵을 16:9 로 눕혔습니다(가로 사용률 30%→100%). 지면을 열면 프리팹 실측 화면 요소 1,575개로 그린 와이어프레임과 버튼별 흐름 · 컨텍스트 상태 기계 · FB 지면 15종이 나옵니다. 메소드·프리팹·버튼 이름으로 검색해 바로 그 지면을 열 수 있습니다.",
      ...
      },
      {
        ...
        desc: "솔리테어 맵과 같은 두 단 구조로 코인 매치 전 지면을 폈습니다. 세로 화면 와이어프레임 위에서 버튼을 누르면 호출 사슬이 그 자리에서 펼쳐집니다. 메소드·프리팹·버튼 이름으로 검색해 바로 그 지면을 열 수 있습니다.",
        url: "docs/coin-match-flow-map.html",
        status: "완료",
        version: "v1.2",
        updated: "2026-08-26 10:35",
        pinned: false,
