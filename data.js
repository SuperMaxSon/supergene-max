    ...
    cards: [
      {
        ...
        desc: "3374 ↔ 3375. 두 빌드는 이 처치 말고 코드가 같습니다. 생성 시도는 −38%인데 실제 생성 성공은 +5.8%로 늘었고 다른 지면 이탈도 없습니다. 잔존은 코호트 격자 66쌍에서 38:28(p≈0.27)로 쏠림이 없고, 처치 층만 떼면 9:2(p≈0.065)까지 갑니다.",
        url: "docs/coin-match-tournament-reject-ab.html",
        project: "cmt",
        status: "진행중",
        version: "v1.6",
        updated: "2026-09-07 11:15",
        pinned: false,
