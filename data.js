...
const SECTIONS = [
  ...
  },
  {
    ...
    cards: [
      ...
      {
        title: "오더 시뮬레이터",
        desc: "밸런스시트 JSON 을 넣으면 벤치와 같은 엔진으로 8단계를 돌려서, 어긋난 항목이 엔진·시트·판정 중 어디 탓인지까지 답합니다. 타입별 난이도 폭과 슬롯 1~5 를 한 줄로 뽑는 리얼 레일까지 봅니다. 2026-09-11 신판 시트 기준.",
        url: "docs/rosewood-order-draw.html",
        project: "smg",
        status: "초안",
        version: "정본 1.3",
        updated: "2026-09-14 16:11",
        pinned: false,
        tags: ["머지", "인터랙티브", "밸런스"],
      },
      {
      ...
      {
        title: "프로토타입",
        desc: "Rosewood 코어루프를 직접 눌러 보는 인게임 시뮬레이터. 2026-09-11 신판 밸런스 시트 실물 234종 31체인이 그대로 돌아갑니다. 아웃게임은 후순위라 접어 뒀습니다.",
        url: "docs/rosewood-order-bench.html",
        project: "smg",
        status: "초안",
        version: "정본 1.3",
        updated: "2026-09-14 16:04",
        pinned: false,
        tags: ["머지", "인터랙티브"],
      },
    ],
    ...
    cards: [
      {
        ...
        desc: "AOS에서 토너먼트가 붙은 컨텍스트의 판 클리어 지면을 공유(A · 빌드 487)에서 생성(B · 빌드 488)으로 바꾸면 수락률이 오르는지 보는 A/B입니다. 두 빌드가 갈리는 건 AOS · 토너 있는 컨텍스트 · 판 클리어 세 조건이 모두 맞을 때뿐이라 분모를 그 조건으로 좁혔고, 어느 칸이 갈리는지를 2단계 판별 도식으로 세웠습니다. 판정 지표는 지표마다 A · B · 차이(pp) · 상대증감(%) 네 칸으로 세워 두고, 주 지표 2개와 가드레일 3개에 채택 조건까지 정의했습니다. 측정 후 숫자만 채우면 되는 틀입니다.",
        url: "docs/sol-clear-create-slot.html",
        project: "sol",
        status: "초안",
        version: "v1.1",
        updated: "2026-09-14 18:50",
        pinned: false,
