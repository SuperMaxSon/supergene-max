...
const SECTIONS = [
  ...
  },
  {
    ...
    cards: [
      ...
      {
        title: "심부름 보상 시트",
        desc: "런칭분 188건이 무엇을 받고 무엇을 무는지를 그림째 폈습니다. 코인·경험치·추가 아이템을 전부 실제 게임 아트로 세워, 코드(2501)만 보고는 알 수 없던 「무엇이 나오는가」가 바로 보입니다. 행을 누르면 그 심부름을 클리어할 때 무엇이 오가는지 — 유형(대화·수선·택1), 비포→애프터, 디자인 택1, 삽화·컷씬·편지 — 가 펼쳐집니다. NPC 아바타는 아트 반입 전이라 자리만 잡아 뒀습니다.",
