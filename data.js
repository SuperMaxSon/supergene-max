    ...
    cards: [
      {
        ...
        desc: "3374 ↔ 3375. 두 빌드는 이 처치 말고 코드가 같습니다. 생성 시도는 −38%인데 실제 생성 성공은 +5.8%로 늘었고 다른 지면 이탈도 없습니다. 리텐션은 stat 사전집계로 다시 뽑아 55쌍 24:31(p≈0.42) 무승부입니다 — 이전 raw 집계는 NRU가 27~31% 과대여서 폐기했습니다.",
        url: "docs/coin-match-tournament-reject-ab.html",
        project: "cmt",
        status: "진행중",
        version: "v2.2",
        updated: "2026-09-07 14:05",
        pinned: false,
