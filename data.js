    ...
    cards: [
      {
        ...
        status: "초안",
        version: "v2.2",
        updated: "2026-09-01 13:40",
        pinned: false,
        tags: ["연출", "튜닝 도구", "인터랙티브"],
      },
      {
        title: "아이소메트릭 데코 영역 — 등장 연출 · 레이어",
        desc: "오브젝트 6개짜리 데코 영역으로 등장 연출 7종을 돌려본다. 레이어(그리기 순서)와 등장 순서를 각각 끌어서 바꾸고 이미지별로 숨겨볼 수 있다.",
      ...
      {
        title: "머지 플로우 시뮬레이터",
        desc: "노드 11개와 대사 37행을 그대로 태워 돌립니다. 대화를 감정 단위로 쪼갠다고 전제하고, 어느 화살표에서 미리 받을지를 메모리 곡선과 대기 시간으로 정합니다 — 쪼개기만 하면 대기는 오히려 늘어납니다.",
        url: "docs/merge-flow-sim.html",
        project: "smg",
        status: "초안",
        version: "v1.2",
        updated: "2026-09-01 14:22",
        pinned: false,
        tags: ["머지", "로딩 설계", "인터랙티브"],
      },
    ],
