    ...
    cards: [
      {
        ...
        desc: "페이스북이 토너먼트를 실제로 만들어놓고 NETWORK_FAILURE를 반환하는 케이스를 되살리는 로직의 검증 결과. 수정 전 빌드 450에서는 되살려도 실패로 기록되고 문구가 다른 기기는 되살리지도 못했는데, 반영 기준 빌드 456부터 되살아난 생성이 로그에 남고 미복구는 0건(최신 빌드 458 동일). 문구가 미묘하게 다른(마침표) 기기 1명도 복구된다. 모든 실패를 되살리는 게 목표는 아니고, 미대응 문구 2종 3명은 손대지 않아도 되는 선택지로 남겨둔다.",
        url: "docs/tournament-create-recovery-result.html",
        status: "완료",
        version: "v1.0",
        updated: "2026-08-20 08:58",
        pinned: false,
