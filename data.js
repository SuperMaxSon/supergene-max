...
const SECTIONS = [
  {
    ...
    cards: [
      ...
      {
        title: "바이럴 격차 — 가로모드 축",
        desc: "파라미터·게이팅·소셜밀도·국가를 전부 통제하고 남은 것은 화면 방향이었다. 사내 7개 중 솔리테어만 가로(1280×720). 마종은 모바일이 데스크톱의 2.1배(Android 33.67% vs Windows 15.82%)인데 우리는 정반대로 모바일이 1/26~0(Android 0.26% · iOS 273시도 0성공). 같은 화면에서 작은 공유 다이얼로그는 산다(10.05%). 실패의 73%가 USER_INPUT — 열리고 나서 닫힌다. 가설 15개 중 11개 기각, 생존 1개. 실기 확인 대기.",
        url: "docs/viral-orientation-gap.html",
        status: "진행중",
        version: "v1.0",
        updated: "2026-08-18 15:03",
        pinned: false,
