    ...
    cards: [
      {
        ...
        desc: "페이스북이 토너먼트를 실제로 만들어놓고 NETWORK_FAILURE를 반환하는 케이스를 되살리는 로직의 검증 결과. 빌드 450에서는 되살려도 실패로 기록되고 문구가 다른 기기는 되살리지도 못했는데, 456·458에서 복구율 0% → 100%, 미복구 0건. 문구가 미묘하게 다른(마침표) 기기 1명도 이제 복구된다. 남은 것은 아직 못 잡는 문구 2종 3명.",
