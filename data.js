    ...
    cards: [
      {
        ...
        desc: "다섯 프로젝트의 공유·초대·전환 코드를 항목별로 나란히 놓고(✅/❌/—), 그 차이가 수치로 나타나는지 US 실측으로 확인. 결론은 시도가 아니라 성공률 문제 — 피드공유 시도는 유저일당 0.113으로 4종 중 2위인데 성공률 43.8%로 최하위(코지·퍼블마 79%, 마종 64%), 응답률도 84.5%로 우리만 5~6pt 낮다. 핵심은 v3의 1순위 가설 반증 — 우리만 다른 iOS·웹 intent가 걸리는 Windows에서 93.4%로 벤치(93.3~95.6%)와 같다. 격차는 전부 Android(솔 27.2% vs 퍼블마 64.8%)이고 거기서는 intent가 벤치와 동일하다. 남은 후보는 Android의 shareDestination·switchContext 미지정이지만 마종이 둘을 넘기고도 37.5%라 단일 원인이 아니다. 우리 시도의 75.6%가 Android(벤치 44~52%)라 OS 쏠림만 16pt 기여. 3600 스크린샷공유는 우리만 234건으로 이중 계상 확인. 다음은 Android 실패 사유(USER_INPUT vs 기술 에러) 하나.",
        url: "docs/viral-surface-cross-project.html",
        status: "진행중",
        version: "v4.0",
        updated: "2026-08-18 17:27",
        pinned: false,
        tags: ["바이럴", "공유", "성공률", "5프로젝트", "OS분해", "BigQuery", "가설반증", "코드실측"],
      },
      {
