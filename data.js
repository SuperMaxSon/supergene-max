    ...
    cards: [
      {
        ...
        desc: "솔리테어 · 코지 · 코인매치 · 마종 · 퍼블마 · 더퍼즐의 신규 유저 첫 10분을 단계축(부팅→첫화면→첫조작→첫판→N판)에 올려 비교. 6개 전부 로비를 건너뛰고 게임 직행하지만, 벤치는 3~5판까지 판만 물리고 솔리테어만 2승에 로비·1200골드 입장료·프리게임 팝업·강제 딤 튜토리얼을 한꺼번에 연다. 강제 딤 튜토리얼이 라이브에서 실제로 도는 건 6개 중 마종과 솔리테어 둘뿐 — 코지는 TU_001 스테이지 부재, 더퍼즐은 cleared=true 하드코딩으로 0건인데 지표는 우리보다 좋다. 결과창 RV(x2)를 NRU에게 노출하는 것도 솔리테어뿐. 크로스 집계용 이벤트 매핑표 + 스키마 무관 SQL 4종 포함.",
        url: "docs/nru-first-10min-compare.html",
        status: "진행중",
        version: "v1.0",
        updated: "2026-08-14",
        pinned: true,
        tags: ["NRU", "온보딩", "튜토리얼", "6프로젝트", "10분", "BigQuery"],
      },
      {
