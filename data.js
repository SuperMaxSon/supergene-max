...
const SECTIONS = [
  ...
  },
  {
    ...
    cards: [
      ...
      {
        title: "오더 추첨 분석",
        desc: "밸런스시트 JSON 을 넣으면 벤치와 같은 엔진으로 8단계를 돌려서, 어긋난 항목이 엔진·시트·판정 중 어디 탓인지까지 답합니다. 2026-09-11 신판 시트(타입 5종·레일 6칸·요구 2자리·반복 카운터) 기준입니다.",
        url: "docs/rosewood-order-draw.html",
        project: "smg",
        status: "초안",
        version: "v4.3",
        updated: "2026-09-11 15:12",
        pinned: false,
        tags: ["머지", "인터랙티브", "밸런스"],
      },
      {
