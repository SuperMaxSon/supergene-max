...
const SECTIONS = [
  {
    ...
    cards: [
      {
        title: "머지 피드백 연출집",
        desc: "머지 보드의 손맛 15종을 문서 안 무대에서 직접 누르고 끌어 본다. 요청받은 액션 6종 · 텍스트 3종에, 없으면 세트가 닫히지 않는 누락 6종을 붙였고, 타이밍 표와 cc.tween 코드가 화면과 같은 값을 쓴다.",
        url: "docs/merge-feedback-anim.html",
        project: "smg",
        status: "초안",
        version: "v1.1",
        updated: "2026-09-01 11:52",
        pinned: false,
        tags: ["연출", "코드 실측", "인터랙티브"],
      },
      {
        title: "아이소메트릭 데코 파츠 등장 연출",
        desc: "부지 위에 데코 10개가 올라오는 등장 연출 7종을 실제 타이밍에 돌려본다. 레이어(그리기 순서) · 등장 순서 · 앵커를 각각 다른 축으로 갈라 정리했다.",
