...
const SECTIONS = [
  ...
  },
  {
    ...
    cards: [
      ...
      {
        title: "심부름 보상 시트",
        desc: "런칭분 188건이 무엇을 받고 무엇을 무는지를 그림째 폈습니다. 코인·경험치·추가 아이템을 전부 실제 게임 아트로 세워, 코드(2501)만 보고는 알 수 없던 「무엇이 나오는가」가 바로 보입니다. 행을 누르면 그 심부름을 클리어할 때 누가 누구와 이야기하는지가 정본 대화 화면 규격 그대로 채팅으로 펼쳐집니다. 대사는 정본에 아직 없어 말풍선을 비워 뒀고, 그 빈 칸이 곧 대사 작업이 들어갈 자리입니다. 구역 6개는 색으로 갈랐습니다. NPC 아바타는 아트 반입 전이라 자리만 잡아 뒀습니다.",
