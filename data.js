  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        desc: "인게임 구조를 표가 아니라 도식 7장으로 세운 문서입니다. 실선은 코드가 있는 칸, 점선은 정본 기획에는 있고 코드가 0줄인 칸이라 어디가 비었는지가 색과 선만 보고 갈립니다. 2026-09-18 09:33 재실측으로 갱신했습니다 — 인게임이 9,220줄에서 14,467줄로 커지면서 연출을 담는 fx 층(5종 1,285줄)이 새로 생겨 5층이 6층이 됐고, 12단계 중 마지막 «마감» 안에서 실패 UX와 연출이 닫혀 남은 칸은 사운드 하나입니다(인게임 CCaudio 참조 0건). 러너는 16종 1,033 PASS / 0 FAIL. 직전 판본의 지적 두 건(MergeFxNode 호출부 0 · PopupInventory 빈 슬롯)은 해소됐고, 대신 IngameVM 이 2,188줄로 커져 BoardOps·OrderOps 분할이 더 밀렸다는 것과 IngameScope.Inventory·Wallet 이 emit 0건인 죽은 통지 축이라는 게 새로 올라왔습니다. 아웃게임은 같은 기간 0줄 그대로입니다.",
