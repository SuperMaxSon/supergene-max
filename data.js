...
const SECTIONS = [
  ...
  },
  {
    ...
    cards: [
      ...
      {
        title: "심부름 보상 시트",
        desc: "런칭분 188건이 무엇을 받고 무엇을 무는지를 그림째 폈습니다. 코인·경험치·추가 아이템을 전부 실제 게임 아트로 세워, 코드(2501)만 보고는 알 수 없던 「무엇이 나오는가」가 바로 보입니다. 행을 누르면 그 심부름을 끝냈을 때 재생되는 대화가 채팅 화면으로 펼쳐집니다. 시트 story 신판으로 scene을 심부름마다 연결해 188건 전부에 대화가 붙고, 재생 시점이 착수·완료·구역 완료로 갈립니다. 한글 대사 2,062줄을 실었고 문장이 아직 없는 50건은 「대사 대기」로 표시했습니다. 구역 6개는 색으로 갈랐습니다. NPC 아바타는 아트 반입 전이라 자리만 잡아 뒀습니다.",
        url: "docs/chore-reward-sheet.html?v=20260921c",
        project: "smg",
        status: "완료",
