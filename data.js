...
const SECTIONS = [
  {
    ...
    cards: [
      ...
      },
      {
        ...
        desc: "다이어그램이 본문인 3단 드릴다운 레퍼런스. 1단 오픈맵으로 전 지면(인트로 → 로비 → 프리게임 → 인게임 → 결과 → 사후 플로우)을 훑고, 지면을 누르면 탭이 열려 그 지면의 다이어그램, 버튼을 누르면 호출 사슬이 단계 다이어그램으로 펼쳐진다. 사슬의 지면 이동 단계를 누르면 그 지면 탭으로 바로 넘어간다. 지면 노드 42 · 흐름 57 · 열람 항목 230(최장 7단계) · onClick 핸들러 182개 실측.",
