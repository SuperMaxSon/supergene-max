...
const SECTIONS = [
  ...
  },
  {
    ...
    cards: [
      ...
      {
        title: "심부름 보상 시트",
        desc: "런칭분 188건이 무엇을 받고 무엇을 무는지를 그림째 폈습니다. 코인·경험치·추가 아이템을 전부 실제 게임 아트로 세워, 코드(2501)만 보고는 알 수 없던 「무엇이 나오는가」가 바로 보입니다. 심부름 앞뒤로 오가는 대화도 재생 순서 그대로 붙였습니다. NPC 아바타는 아트 반입 전이라 자리만 잡아 뒀습니다.",
