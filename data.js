    ...
    cards: [
      {
        ...
        desc: "커밋 문구로 훑고 필요한 것만 눌러서 펼치는 목록. 행마다 작성자 → 커밋 문구 → 해시가 한 줄로 서고, 펼치면 언제·어디서·무엇을·왜·어떻게가 나온다. 왼쪽 색 띠는 영역(이벤트·광고·로그·전환·인프라). 키워드 필터 내장 — 커밋 문구·해시·파일명·사유 전체를 검색하고 본문에만 걸린 행은 자동으로 펼친다. 08-05~08-11 Max 커밋 37건 diff 전량 실측.",
