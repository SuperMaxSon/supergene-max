...
const SECTIONS = [
  {
    ...
    cards: [
      {
        title: "부팅 소실 계측 추가",
        desc: "빌드 480에서 FB SDK 대기 구간의 세션이 사라졌는데 그 자리에 로그가 없어 이탈·SDK 실패·페이지 사망을 끝내 못 갈랐습니다. 그 부채를 갚는 계측의 최종안입니다. 무엇을 넣는지, 무엇을 일부러 뺐는지, 그리고 이걸 다 넣어도 여전히 안 풀리는 것(소실의 규모)까지 적었습니다.",
        url: "docs/boot-log-instrumentation.html",
        project: "sol",
        status: "진행중",
        version: "v1.0",
        updated: "2026-09-02 15:20",
        pinned: false,
        tags: ["코드 실측", "로그 계측"],
      },
      {
