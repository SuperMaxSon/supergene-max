    ...
    cards: [
      {
        ...
        status: "초안",
        version: "v3.2",
        updated: "2026-09-01 15:33",
        pinned: false,
        tags: ["연출", "튜닝 도구", "인터랙티브"],
      },
      {
        title: "아이소메트릭 데코 영역 — 등장 연출 · 레이어",
        desc: "빈 데코 영역에서 미션을 눌러 오브젝트를 하나씩 등장시켜 본다. 보간 1초는 오브젝트 root 하나의 연출 시간, 딜레이는 root 사이 — 맞춘 값이 그대로 Cocos 코드로 나온다.",
        url: "docs/deco-tween-iso.html",
        status: "완료",
        version: "v3.1",
        updated: "2026-09-01 15:34",
        pinned: false,
        project: "smg",
        tags: ["데코", "인터랙티브"],
      },
