  ...
  },
  {
    ...
    cards: [
      ...
      },
      {
        ...
        desc: "9/3~9/6 나흘치. 주지표(공유 성공/DAU)가 +65%로 유의하게 올랐고(p<.001), 초대를 전부 없앴는데도 유입 총량은 오히려 +4%입니다. 통과율은 7.7% → 5.6%로 떨어졌지만 시도를 2.3배 밀어 성공 건수를 늘렸습니다. 리텐션·생성률·배정 균형은 이상 없습니다.",
        url: "docs/sol-tournament-slot-ab.html",
        project: "sol",
        status: "진행중",
        version: "v21.0",
        updated: "2026-09-07 14:32",
        pinned: false,
        tags: ["토너먼트", "BigQuery", "A/B"],
      },
      {
