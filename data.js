...
const SECTIONS = [
  {
    ...
    cards: [
      {
        title: "바이럴 지면 로직 — 프로젝트별 대조",
        desc: "솔리테어·코지·퍼블마·마종·코인매치의 공유·초대·메시지·전환 코드를 항목마다 나란히 놓고 실제 값을 적은 대조표 3개(공유 호출 파라미터 8줄 · 지면과 게이트 14줄 · 로그 8줄) + 할 일 4줄. 솔리테어 칸이 나머지와 다른 줄이 판단 지점 — iOS·웹 intent가 우리만 SHARE(벤치 4종은 REQUEST), 플랫폼 분기 없음, 공유 data 필드가 1개(코지 8·퍼블마 7·마종 5), 3500 position이 숫자, 결과창 공유에 3600+3500 이중 기록. 쿨타임·거절 억제·초대 지면 유무는 벤치도 갈리므로 누가 갖고 있는지를 값으로 표기.",
        url: "docs/viral-surface-cross-project.html",
        status: "완료",
        version: "v3.0",
        updated: "2026-08-18 17:05",
        pinned: false,
        tags: ["바이럴", "공유", "초대", "5프로젝트", "대조표", "코드실측", "로그정의"],
      },
      {
