...
const SECTIONS = [
  ...
  },
  {
    ...
    cards: [
      {
        title: "QA 이슈 23건 — 코드 대조 리포트",
        desc: "슬랙 QA 채널 08-07~08-14 이슈 23건을 클라이언트 코드와 1:1로 맞춰본 기록. 16건 수정 완료(파일:라인 확인) · 4건 논이슈 · 2건 확인 대기 · 실제 미종결은 1건뿐. 완료 표시가 없다고 미해결이 아니라는 점(논이슈 종결 사유는 스레드 마지막 댓글에만 있다), lastDailyDirectEntryAt 읽기 경로 하나가 3건으로 갈라져 접수된 사례, 원인 중 가장 큰 덩어리(6건)가 버그가 아니라 벤치 4종과의 구현 차이였다는 점이 핵심.",
