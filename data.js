...
const SECTIONS = [
  {
    ...
    cards: [
      ...
      },
      {
        ...
        desc: "과노출 → 채널 이동 → 전환율로 좁힌 기록. 억제 배포(빌드 438) 후 총 노출은 마종보다 낮아졌고(45% vs 55%), '생성 24배 폭락'은 채널 이동인 착시였다. 남은 격차는 총 바이럴 6.8배 = 다이얼로그 수락률 4.9%(마종 34.9%) 하나 — 파라미터·게이팅·로그 정의는 이미 마종과 동일. 그리고 빌드 432 이하 지표는 03-10~08-07에만 있던 경로의 로그 결함으로 오염돼 절대값 인용 불가. 가설 16개 중 11개 기각, 정정 9건.",
