...
const SECTIONS = [
  ...
  },
  {
    ...
    cards: [
      ...
      {
        title: "오더 추첨 분석",
        desc: "밸런스시트 JSON 을 넣으면 벤치와 같은 엔진으로 8단계를 돌려서, 판정 근거·뽑기 분포·규칙 위반을 보여 줍니다.",
        url: "docs/rosewood-order-draw.html",
        project: "smg",
        status: "초안",
        version: "v2.1",
        updated: "2026-09-10 18:10",
        pinned: false,
        tags: ["머지", "인터랙티브", "밸런스"],
      },
      {
