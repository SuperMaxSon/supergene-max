...
const SECTIONS = [
  {
    ...
    cards: [
      ...
      {
        title: "스토리 머지 — 착수 점검",
        desc: "2머지 한 벌을 인게임 8·아웃게임 11 묶음으로 갈라 있음 21 / 개선 24 / 없음 99 로 표시한 TODO 매트릭스. 아이템 해부도·생산형 4종·구현 관문 7개를 그림으로 폈고, 버튼 클릭음과 Fbi 저장 경로 판정을 정정했습니다.",
        url: "docs/story-merge-kickoff.html",
        project: "smg",
        status: "초안",
        version: "v2.1",
        updated: "2026-08-27 18:20",
        pinned: false,
        tags: ["착수 점검", "역기획", "스토리머지", "시스템 언팩", "인게임·아웃게임"],
      },
      {
